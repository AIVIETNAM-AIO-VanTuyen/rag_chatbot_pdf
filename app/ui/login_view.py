...
from app.ui.state import get_container, sign_in
from app.usecases.authenticate import authenticate
...
def show_login_view():
    ...
    with col2:
        ...
        with st.form("login_form", clear_on_submit=False):
            ...
            if submit:
                if authenticate(username, password, get_container().settings):
                    sign_in(username.strip())
